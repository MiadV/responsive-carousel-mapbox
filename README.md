# Responsive Carousel + MapBox

> Inspired by [seedtrace.org](https://seedtrace.org/supply-chain-visualization).

[**👉View Live**](https://codesandbox.io/s/responsive-carousel-mapbox-seedtrace-zf411x)

Join my youtube channel. [Youtube Channel](https://www.youtube.com/c/MiadVosoughi)

![Responsive Carousel + MapBox](/preview.png)
...
Open [http://127.0.0.1:5173/](http://127.0.0.1:5173/) in your browser to see the result.
